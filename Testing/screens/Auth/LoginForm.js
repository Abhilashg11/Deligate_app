  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <DisplayText style={styles.subtitle}>
          {loginForm.subtitle}
        </DisplayText>
        ...
        {/* Password */}
        <DisplayText style={styles.label}>{loginForm.passwordLabel}</DisplayText>
        ...
        {/* Forgot */}
        <TouchableOpacity>
          <DisplayText style={styles.forgot}>{loginForm.forgotLabel}</DisplayText>
        </TouchableOpacity>

        {/* Login */}
          <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}} colors={['#0D5F7A','#1780A0','#239EC4']} style={styles.loginButton}>
          <Button
                color={"#ffffff"}
                title={"SignIn"}
        ...
        <DisplayText style={styles.bottom}>
          Need access? <DisplayText style={styles.link}>Request an account</DisplayText>
        </DisplayText>
      </View>
